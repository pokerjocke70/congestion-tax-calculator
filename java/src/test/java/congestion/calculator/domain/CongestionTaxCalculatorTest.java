...
class CongestionTaxCalculatorTest {
    ...
    private final List<TaxPeriod> billablePeriods = List.of(
    ...
    void getTax(String tollDate, int expectedTollFee) {
        ...
        // When
        var tollFee = new CongestionTaxCalculator().getTollFee(date, billablePeriods);
    ...
    void getTollFee(List<String> dates, int expectedTollFee) {
        ...
        // When
        var tollFee = new CongestionTaxCalculator().getTax(tollDates, 60, 60, billablePeriods);
    ...
    private static Stream<Arguments> getTaxValues() {
        return Stream.of(
                ...
                Arguments.of(List.of("2013-12-02T06:23:00", "2013-12-02T07:03:00", "2013-12-02T17:53:00", "2013-12-03T06:23:00", "2013-12-03T07:03:00", "2013-12-03T17:53:00"), 62),
